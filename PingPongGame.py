...
ball.shape("square")         #to give shape to the paddle
ball.color("white")
ball.penup()
ball.dx=0.07
ball.dy=-0.07
...
def Paddle_L_Up():
    y= Paddle_L.ycor()  # to get the y coordinate of the left paddle
    y=y+20
    Paddle_L.sety(y)
...
#keyboard binding
window.listen()
window.onkeypress(Paddle_L_Up, "w")   #when the second argument key is pressed then the function of first argumwnt is called
